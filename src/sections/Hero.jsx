  ...
  return (
    ...
    className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container'>
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
        <p
        className='text-xl font-montserrat text-coral-red'>Our Summer Collection</p>
        <h1
        className='lg:mt-10 font-palanquin text-8xl max-sm:text-[55px] max-sm:leading-[82px] font-bold'>
          <span 
      ...
      max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        ...
        <div
        className='flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[17%] max-sm:px-6'>
