    ...
    className="max-container">
      ...
      className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        ...
        className="flex flex-col items-start">
          ...
          <p
          className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:mas-w-sm">
            ...
            className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
              {footerLinks.map(section  =>(
                ...
                >
                  <h4
                  className="text-white font-montserrat font-2xl leading-normal font-medium mb-6">
                    {section.title}</h4>
                    <ul>
